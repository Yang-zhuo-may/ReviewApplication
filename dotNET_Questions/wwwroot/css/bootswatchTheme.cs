...
[data-bs-theme=dark]
{
  ...
  --bs - heading - color: inherit;
    --bs - link - color: #8fb4f4;
  --bs - link - hover - color: #a5c3f6;
  --bs - link - color - rgb: 143, 180, 244;
    --bs - link - hover - color - rgb: 165, 195, 246;
    --bs - code - color: #f18bba;
  --bs - highlight - color: #ddd;
  --bs - highlight - bg: #60451f;
  --bs - border - color: #495057;
  --bs - border - color - translucent: rgba(255, 255, 255, 0.15);
    --bs - form - valid - color: #67d4ac;
  --bs - form - valid - border - color: #67d4ac;
...
.form -switch .form - check - input:focus {
  --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23a2c1f6'/%3e%3c/svg%3e");
}
...
background - image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2302b875' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
background - repeat: no - repeat;
...
.was - validated.form - select:valid: not([multiple]):not([size]), .was - validated.form - select:valid: not([multiple])[size = "1"], .form - select.is -valid:not([multiple]):not([size]), .form - select.is -valid:not([multiple])[size = "1"] {
    --bs - form - select - bg - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2302b875' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.nav - pills {
  ...
  --bs - nav - pills - link - active - bg: #4582ec;
}
.nav - pills.nav - link {
...
.navbar {
    ...
    --bs - navbar - toggler - border - radius: 1.078em;
...
.accordion {
    ...
    --bs - accordion - btn - active - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%231c345e' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
    --bs - accordion - btn - focus - box - shadow: 0 0 0 0.25rem rgba(69, 130, 236, 0.25);
...
[data - bs - theme = dark].accordion - button::after {
    --bs - accordion - btn - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%238fb4f4'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
    --bs - accordion - btn - active - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%238fb4f4'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.pagination {
    ...
    --bs - pagination - focus - box - shadow: 0 0 0 0.25rem rgba(69, 130, 236, 0.25);
    --bs - pagination - active - color: #fff;
  --bs - pagination - active - bg: #4582ec;
  --bs - pagination - active - border - color: #4582ec;
...
.list - group {
  ...
  --bs - list - group - active - bg: #4582ec;
  --bs - list - group - active - border - color: #4582ec;
  display: flex;
    flex - direction: column;
    padding - left: 0;
    margin - bottom: 0;
...
.btn - close {
  ...
  --bs - btn - close - bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23000'%3e%3cpath d='M.293.293a1 1 0 0 1 1.414 0L8 6.586 14.293.293a1 1 0 1 1 1.414 1.414L9.414 8l6.293 6.293a1 1 0 0 1-1.414 1.414L8 9.414l-6.293 6.293a1 1 0 0 1-1.414-1.414L6.586 8 .293 1.707a1 1 0 0 1 0-1.414z'/%3e%3c/svg%3e");
    ...
    --bs - btn - close - focus - shadow: 0 0 0 0.25rem rgba(69, 130, 236, 0.25);
...
color: RGBA(55, 104, 189, var(--bs - link - opacity, 1))!important;
    -webkit - text - decoration - color: RGBA(55, 104, 189, var(--bs - link - underline - opacity, 1))!important;
    text - decoration - color: RGBA(55, 104, 189, var(--bs - link - underline - opacity, 1))!important;
}
...
color: RGBA(2, 147, 94, var(--bs - link - opacity, 1))!important;
    -webkit - text - decoration - color: RGBA(2, 147, 94, var(--bs - link - underline - opacity, 1))!important;
    text - decoration - color: RGBA(2, 147, 94, var(--bs - link - underline - opacity, 1))!important;
}
